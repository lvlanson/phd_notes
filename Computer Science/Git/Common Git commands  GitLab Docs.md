---
title: "Common Git commands | GitLab Docs"
...
For more information, see [Add files to your branch](https://docs.gitlab.com/topics/git/add_files/).
...
For more information, see [Git file blame](https://docs.gitlab.com/user/project/repository/files/git_blame/).
...
For more information, see [Create a Git branch for your changes](https://docs.gitlab.com/topics/git/branch/).
...
For more information, see [Clone a Git repository to your local computer](https://docs.gitlab.com/topics/git/clone/).
...
For more information, see [Stage, commit, and push changes](https://docs.gitlab.com/topics/git/commit/).
...
For more information, see [Undo changes](https://docs.gitlab.com/topics/git/undo/).
...
For more information on configuring additional remotes, see [Forks](https://docs.gitlab.com/user/project/repository/forking_workflow/).
...
For more information on an alternative to `git merge`, see [Rebase to address merge conflicts](https://docs.gitlab.com/topics/git/git_rebase/).
...
You can use `git rebase` to [resolve merge conflicts](https://docs.gitlab.com/topics/git/git_rebase/).
