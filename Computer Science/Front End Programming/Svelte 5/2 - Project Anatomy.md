...
```html title=Component.svelte showLineNumbers
<script lang="ts">
...
```html title=File.svelte {2,5} showLineNumbers
<script lang="ts">
...
```html title=File.svelte {5} showLineNumbers
<script lang="ts">
	import Component from './Component.svelte'
</script>
...
```html title=Component.svelte showLineNumbers {2,5}
<script lang="ts">
	let { data } = $props();
</script>
...
```hmtl title=Component.svelte {2} showLineNumbers
<script lang="ts">
...
```html title=Component.svelte {4,7} showLineNumbers
<script lang="ts">
	let { 
			data,
			otherData 
...
```html title=Component.svelte {4} showLineNumbers
<script lang="ts">
	let { 
			data,
