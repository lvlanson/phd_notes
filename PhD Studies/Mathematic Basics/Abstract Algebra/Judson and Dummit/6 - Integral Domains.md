...
>Every field is also an integral domain; however, there are many [[1 - Algebraic Structures#^f48d09|integral domains]] that are not [[1 - Algebraic Structures#^a17f1c|fields]]. For example, the integers $\mathbb{Z}$ form an [[1 - Algebraic Structures#^f48d09|integral domain]] but not a [[1 - Algebraic Structures#^a17f1c|field]]. 
>
