...
> Since $\boldsymbol{u}$ is a unit vector, i.e. $\left\vert\left\vert\, \boldsymbol{u} \,\right\vert\right\vert = 1$ it follows that we yield the expression from our last theorem, i.e.
