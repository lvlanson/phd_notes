...
> $$\text{Dec}(c_{1}\oplus c_{2})=m_{1}+m_{2} = \text{Dec}(c_{1})+ \text{Dec}(c_{2})$$
>
...
> 
> beantwortet werden sollen, ohne den Inhalt der Daten zu teilen.
> 
...
## 13.1 Mathematische und Terminologische Grundlagen
...
>
>>[!remark] Wichte Bemerkung: Einordnung
...
>Wir bezeichnen ein homomorphes Verschlüsselungsschema als **vollständig homomorph**, wenn die $\text{eval}$-Funktion 
>- eine beliebige Anzahl an Operationen auf den Chiffren erlaubt 
>- die Operationen durch eine additive und eine multiplikative Operation charakterisiert sind 
>- die Größe der Chiffren unabhängig von der Anzahl oder Komplexität der durchgeführten Operationen bleibt
